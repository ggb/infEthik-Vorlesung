...
Im dritten Kapitel rückt die Methode *Impact Statement* erneut in den Vordergrund. In Abschnitt 9 wurde bereits ausführlich das Vorgehen zum Verfassen eines *Impact Statements* erläutert. Nun wird genauer betrachtet, warum ein *Impact Statement* verfasst werden sollte und es werden zwei Beispiele vorgestellt.
...
**ACHTUNG:** In früheren Durchführungen dieses Moduls haben wir als Prüfungs(vor)leistung die Einreichung schriftlicher Abgaben verlangt, wie unten beschrieben. Dies ist nicht länger der Fall, aber die gesammelten Informationen können dennoch als Referenz für das Schreiben wissenschaftlicher Texte dienen und sind in diesem Sinne hier abgelegt.
